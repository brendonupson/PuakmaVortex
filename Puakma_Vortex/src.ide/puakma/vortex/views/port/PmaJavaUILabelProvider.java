...
public class PmaJavaUILabelProvider implements ILabelProvider, IColorProvider
{
  protected ListenerList<ILabelProviderListener> fListeners = new ListenerList<ILabelProviderListener>();
   ...
   */
  public PmaJavaUILabelProvider(long textFlags, int imageFlags)
  {
  ...
  {
    Image result = fImageLabelProvider
        .getImageLabel(element, evaluateImageFlags(element));
